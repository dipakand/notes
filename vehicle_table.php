...
if(isset($_POST['btn_down']))
{
    ...
    //                echo "<script>alert('Successfully download File.!!');</script>";
    //                echo "<meta http-equiv='refresh' content='0'>";
    //            }
    //            else
    //            {
    //                echo "<script>alert('File does not exists on given path');</script>";
    //                echo "<meta http-equiv='refresh' content='0'>";
    //            }
    //        }
    // Get parameters
...
<div class="panel-heading">
<h4 class="panel-title">
<a data-toggle="collapse" data-parent="#accordion" href="#collapse3">File</a>
</h4>
</div>
...
<div class="panel-heading">
<h4 class="panel-title">
<a data-toggle="collapse" data-parent="#accordion" href="#collapse6">View Files</a>
</h4>
</div>
                        ...
                        <div class="panel-body">
                            <form  method="post" name="form12" class="form-group">
                                <div class="row">   
                                    ...
                                    <div class="col-sm-2" >
                                        <input type="submit" name="btn_filsub" class="btn btn-success btn-block" value="Submit" />
                                    </div>
                                </div>
                            </form>
                        </div>
...
-->
                ...
                <div class="row" id="viewselectTable"></div>
                <div class="row" id="viewupdateTable"></div>
                <div class="row" id="viewupdateTable1"></div>
                <div class="row" id="viewupdateTable2"></div>
                <div class="row" id="viewupdateTable3"></div>
                <div class="row" id="viewfolderstru"></div>
                <div class="row" id="viewalltable"></div>
                <div class="row ">
                    <?php
